...
realtime.initializate("serviceapp/photos", model_name="Facenet512", detector_backend="retinaface",
                      distance_metric="euclidean",
                      enable_face_analysis=False, time_threshold=1, frame_threshold=1)


def facecatch(image):
    return realtime.analysis("serviceapp/photos", image, model_name="Facenet512", detector_backend="retinaface",
                             distance_metric="euclidean",
                             enable_face_analysis=False, time_threshold=1, frame_threshold=1)
