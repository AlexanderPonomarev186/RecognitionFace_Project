...
from serviceapp.databasemongodbapi import User, createuser
...
def initializatedb(
    ...
    for index in pbar:
        ...
        for img_content, _, _ in img_objs:
            ...
            createuser(f"{employee}", img_representation)
...
def find(
    ...
    for user in User.objects:
        representations.append([user.name, user.face_vector])
    # ----------------------------
